			...
			<Shell>
				<div className="max-w-md mx-auto mt-16 text-center animate-fade-in">
					<div className="border border-border bg-panel p-8">
						...
						<h2 className="font-mono text-sm tracking-wide text-text-secondary mb-2">
							REQUEST EXPIRED
						</h2>
		...
		return (
			<Shell>
				<div className="max-w-md mx-auto mt-16 text-center animate-slide-up">
					<div
						className={`border ${approved ? "border-green-dim bg-green-glow" : "border-border bg-panel"} p-8`}
					>
						<div
							className={`w-3 h-3 ${approved ? "bg-green" : "bg-text-muted"} mx-auto mb-4`}
						/>
					...
					<div className="border border-blue-dim bg-panel p-8">
						<div className="flex items-center justify-center gap-1.5 mb-4">
							...
							<div
								...
								style={{
									animation:
										"pulse-glow 1s ease-in-out 0.2s infinite",
								}}
							/>
							<div
								className="w-1.5 h-1.5 bg-blue rounded-full"
								style={{
									animation:
										"pulse-glow 1s ease-in-out 0.4s infinite",
								}}
							/>
						</div>
						<h2 className="font-mono text-sm tracking-wide text-text-primary mb-2">
			...
			<div className="animate-fade-in">
				...
				<div className="mb-8">
					<div className="flex items-center gap-2 mb-1">
						<div
							className={`w-2 h-2 ${summary.hasHighRisk ? "bg-red" : "bg-amber"}`}
						/>
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6 stagger-children">
					<InfoBlock
						...
						value={grant.agent_name}
						sub={grant.agent_id}
					/>
					<InfoBlock
						label="TARGET SERVICE"
						value={grant.service_provider_name}
						sub={grant.service_provider_id}
					/>
				</div>
					...
					<div className="border border-border bg-panel-raised max-w-lg w-full p-6 animate-slide-up">
						{confirmStep === 1 ? (
							<>
								...
								<p className="text-text-primary text-sm font-medium mb-6">
		...
		<div className="min-h-screen">
			...
			<div className="border-b border-border bg-panel">
				<div className="max-w-3xl mx-auto px-4 sm:px-6 h-12 flex items-center justify-between">
					...
					<Link
						to="/agents"
						className="font-mono text-xs text-text-muted hover:text-text-secondary transition-colors tracking-wide"
					>
						AGENTS
					</Link>
				</div>
...
function InfoBlock({
	...
	return (
		<div className="border border-border bg-panel p-4">
			<div className="font-mono text-[10px] tracking-widest text-text-muted mb-2">
				{label}
			</div>
