...
impl From<auth_core::CoreError> for SdkError {
    fn from(err: auth_core::CoreError) -> Self {
        match err {
            auth_core::CoreError::Crypto(e) => SdkError::CryptoError(e.to_string()),
            _ => SdkError::InternalError(err.to_string()),
        }
    }
}

impl From<auth_core::error::CryptoError> for SdkError {
    fn from(err: auth_core::error::CryptoError) -> Self {
